...
import com.nilton.simplecrud.controllers.util.URL;
...
public class UserController {
	...
	public ResponseEntity<List<User>> getByTitle(@RequestParam(value="text", defaultValue = "") String text) {
	...
	public ResponseEntity<List<User>> getByEmail(@RequestParam(value="text", defaultValue = "") String text) {
		text = URL.decodeParam(text);
		List<User> list = service.findByName(text);		
		return ResponseEntity.ok().body(list);
	}
